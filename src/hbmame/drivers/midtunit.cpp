...
ROM_START( mkr4legacy )
	...
	ROM_LOAD16_BYTE( "l4_mortal_kombat_t-unit_uj12_game_rom.uj12", 0x00000, 0x80000, CRC(647dee22) SHA1(4bfdd46d84822b88e82add507a100a045e2b04fa) )
	ROM_LOAD16_BYTE( "l4_mortal_kombat_t-unit_ug12_game_rom.ug12", 0x00001, 0x80000, CRC(2fc516ca) SHA1(51fe25a169f519c0bfc52462cf6d15b7a6724061) )
...
ROM_START( mk2r31legacy )
	...
	ROM_REGION16_LE( 0x100000, "maincpu", 0 )   /* 34010 code */
 	ROM_LOAD16_BYTE( "uj12.l31e", 0x00000, 0x80000, CRC(7c24dbc2) SHA1(3eec63e263cb922abc28893208c0de57b6b3a506) ) /* Revision 3.1 Legacy */
 	ROM_LOAD16_BYTE( "ug12.l31e", 0x00001, 0x80000, CRC(8a76ba82) SHA1(1c9e706c6125c92894cd1f1056e6410014b47c23) )
...
GAME( 1992, mkr4legacy,       mk,       tunit_adpcm, mk,       midtunit_state, init_mktunit,  ROT0, "Midway",   "Mortal Kombat (rev 4.0 T-Unit 02/11/93) - Legacy", MACHINE_SUPPORTS_SAVE )
// Mortal Kombat II
